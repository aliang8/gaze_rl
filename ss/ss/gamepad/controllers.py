...
from ss.gamepad.gamepad import Gamepad
...
class GameHat(Gamepad):
    ...
    def __init__(self, joystickNumber=0):
        Gamepad.__init__(self, joystickNumber)
        self.axisNames = {0: "LEFT-X", 1: "LEFT-Y"}
        self.buttonNames = {
            0: "A",
            1: "B",
            2: "X",
...
class example(Gamepad):
    ...
    def __init__(self, joystickNumber=0):
        Gamepad.__init__(self, joystickNumber)
        self.axisNames = {0: "AXIS0", 1: "AXIS1", 2: "AXIS2"}
        self.buttonNames = {0: "BUTTON0", 1: "BUTTON1", 2: "BUTTON2"}
        self._setupReverseMaps()
